...
class WindowFeatureExtractor:
    ...
    def extract(self, stats: WindowStats) -> WindowFeatures:
        ...
        packets_per_second = (
            stats.packet_count / seconds
        )

        bytes_per_second = (
            stats.byte_count / seconds
        )

        flows_per_second = (
            stats.flow_count / seconds
        )
